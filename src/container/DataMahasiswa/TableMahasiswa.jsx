            ...
            <thead className="thead-light">
                ...
                </thead>
                {
                    this.state.dataMahasiswa.map(mahasiswa => {
                        return <Mahasiswa key={mahasiswa.nim} nim={mahasiswa.nim} nama={mahasiswa.nama} alamat={mahasiswa.alamat} hp={mahasiswa.hp} angkatan={mahasiswa.angkatan} status={mahasiswa.status} hapusData={this.handleHapusData}/>
                    })
                }
            </table>
